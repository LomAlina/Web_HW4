...
$works = [
  ...
  "description" => "Проведение встреч и презентаций, заключение договоров, выполнение плановых показателей по продажам ",
  ],
  [
  "name" => "Ассистент менеджера",
  "dateStart" => "Ноябрь 2018",
  "dateEnd" => "Декабрь 2020",
  "description" => "Осуществление подготовительной работы для встреч менеджера с клиентов, формирование договоров, ведение текущей документации",
  ],
  [
  "name" => "Администратор",
  "dateStart" => "Март 2017",
  "dateEnd" => "Ноябрь 2018",
  "description" => "Ведение календаря руководителя, назначение встреч и совещаний, контроль документооборота",
  ],
];
?>
<!DOCTYPE html>
      ...
      <div class="w3-third">
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-container">
            <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i><?= $position; ?></p>
